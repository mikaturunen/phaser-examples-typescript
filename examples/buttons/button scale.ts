...
var button1: Phaser.Button;
var button2: Phaser.Button;
var button3: Phaser.Button;
var button3: Phaser.Button;
var button4: Phaser.Button;
...
var game: Game.Phaser = new Phaser.Game(800, 600, Phaser.CANVAS, "phaser-example", { 
    ...
    create: () => {
        ...
        button1 = game.add.button(100, 100, "button", buttonScaleChangeSky, this, 2, 1, 0);
        button1.name = "sky1";
        button1.anchor.setTo(0.5, 0.5);

        //  Rotated button
        button2 = game.add.button(330, 200, "button", buttonScaleChangeSky, this, 2, 1, 0);
        button2.name = "sky2";
        button2.angle = 24;
        button2.anchor.setTo(0.5, 0.5);

        //  Width scaled button
        button3 = game.add.button(100, 300, "button", buttonScaleChangeSky, this, 2, 1, 0);
        button3.name = "sky3";
        button3.width = 300;
        ...
        //  Scaled button
        button4 = game.add.button(300, 450, "button", buttonScaleChangeSky, this, 2, 1, 0);
        button4.name = "sky4";
        button4.scale.setTo(2, 2);

        //  Shrunk button
        button5 = game.add.button(100, 450, "button", buttonScaleChangeSky, this, 2, 1, 0);
        button5.name = "sky5";
        button5.scale.setTo(0.5, 0.5);

        //  Scaled and Rotated button
        button6 = game.add.button(570, 200, "button", buttonScaleChangeSky, this, 2, 1, 0); // anchor 0.5
        button6.name = "sky6";
        button6.angle = 32;
