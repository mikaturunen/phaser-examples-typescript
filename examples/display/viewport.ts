...
var game: Phaser.Game = new Phaser.Game(800, 600, Phaser.CANVAS, "phaser-example", { 
    create: () => game.stage.backgroundColor = "#440e62", 
    ...
    render: () => {
        ...
        game.debug.text("Viewport Width: " + (<any>game).scale.viewportWidth, x, y += yi);
        game.debug.text("window.innerWidth: " + window.innerWidth, x, y += yi);
        game.debug.text("window.outerWidth: " + window.outerWidth, x, y += yi);

        game.debug.text("Viewport Height: " + (<any>game).scale.viewportHeight, x, y += yi);
        ...
        game.debug.text("Document Width: " + (<any>game).scale.documentWidth, x, y += yi);
        game.debug.text("Document Height: " + (<any>game).scale.documentHeight, x, y += yi);
